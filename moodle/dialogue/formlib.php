...
class mod_dialogue_conversation_form extends mod_dialogue_message_form {
    ...
    protected function definition() {
        ...
        /* -----------------------------------------------------------------------------------------------------------*/
        /*$users = get_user_from_course($context->instanceid);
        ...
        echo '<br/><br/><br/><br/><br/>';
        echo '<pre>';
        var_dump($users['selected']);
        echo '</pre>';

        $mform->addElement('select', 'useridsselected', get_string('users'), $options);
        $mform->getElement('useridsselected')->setMultiple(true);
        $mform->getElement('useridsselected')->setSelected($selected);
        ...
        $mform->addElement('autocomplete', 'useridsselected', get_string('users'), $users['selected'], $options);
        $mform->addRule('useridsselected', null, 'required', null, 'client');
