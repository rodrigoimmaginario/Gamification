...
$string['selectroles'] = 'Papéis disponíveis';
$string['roles_help'] = 'Selecione os papéis diponíveis para contato. Mantenha a tecla Ctrl para selecionar mais de um';
$string['selectroles_required'] = 'Selecione, pelo menos, um papel';
