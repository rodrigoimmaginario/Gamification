...
class global_navigation extends navigation_node {
    ...
    public function add_course_essentials($coursenode, stdClass $course) {
        ...
        if ($navoptions) {
            $url = 'https://ceadgraduacao.uvv.br/course/view.php?id=854';
            $coursenode->add('Tutoriais', $url, navigation_node::TYPE_SETTING, null, 'tutorialsview');            
        }
    ...
    public function add_front_page_course_essentials(navigation_node $coursenode, stdClass $course) {
        ...
        if ($navoptions) {            
            ...
            $node = $coursenode->add('Tutoriais', $url, self::TYPE_CUSTOM, null, 'tutorialsview');
            $node->showinflatnavigation = true;
